...
class Bigser(models.Model):
    ...
    logo_black = models.FileField(blank=True, null=True, verbose_name=_('Логотип черный'))
    logo_white = models.FileField(blank=True, null=True, verbose_name=_('Логотип белый'))
